...
import static asc.foods.gateway.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static asc.foods.gateway.test.util.OAuth2TestUtil.authenticationToken;
import static asc.foods.gateway.test.util.OAuth2TestUtil.registerAuthenticationToken;
