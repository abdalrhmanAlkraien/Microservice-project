package asc.foods.search.service;
...
import asc.foods.search.IntegrationTest;
import asc.foods.search.config.Constants;
import asc.foods.search.repository.search.UserSearchRepository;
import asc.foods.search.security.AuthoritiesConstants;
import asc.foods.search.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the asc.foods.search.repository.search test package.
     *
     * @see asc.foods.search.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
