...
@RestController
@RequestMapping("/api/search-service-kafka")
public class SearchServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SearchServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SearchServiceKafkaResource(KafkaProperties kafkaProperties) {
