...
import asc.foods.user.domain.enumeration.Gender;
import asc.foods.user.domain.enumeration.UserStatus;
import asc.foods.user.domain.enumeration.UserType;
...
/**
 * A DTO for the {@link asc.foods.user.domain.AppUser} entity.
 */
