...
@RestController
@RequestMapping("/api/user-service-kafka")
public class UserServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(UserServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public UserServiceKafkaResource(KafkaProperties kafkaProperties) {
