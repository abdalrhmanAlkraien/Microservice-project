...
import asc.foods.user.repository.DriverRepository;
import asc.foods.user.service.DriverService;
import asc.foods.user.service.dto.DriverDTO;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.Driver}.
 */
@RestController
@RequestMapping("/api")
public class DriverResource {
    ...
    private static final String ENTITY_NAME = "userServiceDriver";
