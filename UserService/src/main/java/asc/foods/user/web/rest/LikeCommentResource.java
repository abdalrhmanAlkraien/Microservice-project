...
import asc.foods.user.service.LikeCommentService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.LikeComment}.
 */
@RestController
@RequestMapping("/api")
public class LikeCommentResource {
    ...
    private static final String ENTITY_NAME = "userServiceLikeComment";
