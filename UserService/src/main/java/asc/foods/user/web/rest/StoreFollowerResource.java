...
import asc.foods.user.service.StoreFollowerService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.StoreFollower}.
 */
@RestController
@RequestMapping("/api")
public class StoreFollowerResource {
    ...
    private static final String ENTITY_NAME = "userServiceStoreFollower";
