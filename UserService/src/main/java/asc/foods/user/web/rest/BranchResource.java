...
import asc.foods.user.service.BranchService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.Branch}.
 */
@RestController
@RequestMapping("/api")
public class BranchResource {
    ...
    private static final String ENTITY_NAME = "userServiceBranch";
