...
import asc.foods.user.service.ViwedStoryService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.ViwedStory}.
 */
@RestController
@RequestMapping("/api")
public class ViwedStoryResource {
    ...
    private static final String ENTITY_NAME = "userServiceViwedStory";
