...
import asc.foods.user.repository.OrderProductRepository;
import asc.foods.user.service.OrderProductService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.OrderProduct}.
 */
@RestController
@RequestMapping("/api")
public class OrderProductResource {
    ...
    private static final String ENTITY_NAME = "userServiceOrderProduct";
