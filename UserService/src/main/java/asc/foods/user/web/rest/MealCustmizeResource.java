...
import asc.foods.user.service.MealCustmizeService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.MealCustmize}.
 */
@RestController
@RequestMapping("/api")
public class MealCustmizeResource {
    ...
    private static final String ENTITY_NAME = "userServiceMealCustmize";
