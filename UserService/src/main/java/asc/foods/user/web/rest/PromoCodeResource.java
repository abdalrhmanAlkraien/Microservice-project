...
import asc.foods.user.service.PromoCodeService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.PromoCode}.
 */
@RestController
@RequestMapping("/api")
public class PromoCodeResource {
    ...
    private static final String ENTITY_NAME = "userServicePromoCode";
