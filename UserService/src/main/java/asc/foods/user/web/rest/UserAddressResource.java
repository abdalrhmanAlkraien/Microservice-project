...
import asc.foods.user.repository.UserAddressRepository;
import asc.foods.user.service.UserAddressService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.UserAddress}.
 */
@RestController
@RequestMapping("/api")
public class UserAddressResource {
    ...
    private static final String ENTITY_NAME = "userServiceUserAddress";
