...
import asc.foods.user.service.ProductService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "userServiceProduct";
