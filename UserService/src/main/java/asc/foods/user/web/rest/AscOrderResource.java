...
import asc.foods.user.repository.AscOrderRepository;
import asc.foods.user.service.AscOrderService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.AscOrder}.
 */
@RestController
@RequestMapping("/api")
public class AscOrderResource {
    ...
    private static final String ENTITY_NAME = "userServiceAscOrder";
