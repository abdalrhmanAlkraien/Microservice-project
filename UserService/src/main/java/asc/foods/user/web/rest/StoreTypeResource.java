...
import asc.foods.user.service.StoreTypeService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.StoreType}.
 */
@RestController
@RequestMapping("/api")
public class StoreTypeResource {
    ...
    private static final String ENTITY_NAME = "userServiceStoreType";
