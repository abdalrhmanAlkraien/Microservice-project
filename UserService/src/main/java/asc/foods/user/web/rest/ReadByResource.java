...
import asc.foods.user.service.ReadByService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.ReadBy}.
 */
@RestController
@RequestMapping("/api")
public class ReadByResource {
    ...
    private static final String ENTITY_NAME = "userServiceReadBy";
