...
import asc.foods.user.repository.RatingRepository;
import asc.foods.user.service.RatingService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.Rating}.
 */
@RestController
@RequestMapping("/api")
public class RatingResource {
    ...
    private static final String ENTITY_NAME = "userServiceRating";
