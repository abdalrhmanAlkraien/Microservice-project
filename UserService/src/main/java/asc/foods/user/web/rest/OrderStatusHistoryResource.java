...
import asc.foods.user.service.OrderStatusHistoryService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.OrderStatusHistory}.
 */
@RestController
@RequestMapping("/api")
public class OrderStatusHistoryResource {
    ...
    private static final String ENTITY_NAME = "userServiceOrderStatusHistory";
