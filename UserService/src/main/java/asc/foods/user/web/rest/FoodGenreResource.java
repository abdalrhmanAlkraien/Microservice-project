...
import asc.foods.user.service.FoodGenreService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.FoodGenre}.
 */
@RestController
@RequestMapping("/api")
public class FoodGenreResource {
    ...
    private static final String ENTITY_NAME = "userServiceFoodGenre";
