...
import asc.foods.user.service.RoomService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.Room}.
 */
@RestController
@RequestMapping("/api")
public class RoomResource {
    ...
    private static final String ENTITY_NAME = "userServiceRoom";
