...
import asc.foods.user.repository.SaveRepository;
import asc.foods.user.service.SaveService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.Save}.
 */
@RestController
@RequestMapping("/api")
public class SaveResource {
    ...
    private static final String ENTITY_NAME = "userServiceSave";
