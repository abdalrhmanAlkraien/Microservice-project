...
import asc.foods.user.service.ProductOptionService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.ProductOption}.
 */
@RestController
@RequestMapping("/api")
public class ProductOptionResource {
    ...
    private static final String ENTITY_NAME = "userServiceProductOption";
