...
import asc.foods.user.service.BranchDeliveryMethodService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.BranchDeliveryMethod}.
 */
@RestController
@RequestMapping("/api")
public class BranchDeliveryMethodResource {
    ...
    private static final String ENTITY_NAME = "userServiceBranchDeliveryMethod";
