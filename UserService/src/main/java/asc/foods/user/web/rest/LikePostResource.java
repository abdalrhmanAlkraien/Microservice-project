...
import asc.foods.user.service.LikePostService;
...
/**
 * REST controller for managing {@link asc.foods.user.domain.LikePost}.
 */
@RestController
@RequestMapping("/api")
public class LikePostResource {
    ...
    private static final String ENTITY_NAME = "userServiceLikePost";
