...
import asc.foods.store.domain.Comment;
import asc.foods.store.repository.CommentRepository;
import asc.foods.store.service.CommentService;
import asc.foods.store.service.dto.CommentDTO;
import asc.foods.store.service.mapper.CommentMapper;
...
class CommentResourceIT {
    ...
    private static final Instant DEFAULT_COMMENT_TIME = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_COMMENT_TIME = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getCommentTime()).isEqualTo(DEFAULT_COMMENT_TIME);
        assertThat(testComment.getCreatedBy()).isEqualTo(DEFAULT_CREATED_BY);
        assertThat(testComment.getImageUrl()).isEqualTo(DEFAULT_IMAGE_URL);
        assertThat(testComment.getReplay()).isEqualTo(DEFAULT_REPLAY);
    }
    ...
    void getAllComments() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.[*].commentTime").value(hasItem(DEFAULT_COMMENT_TIME.toString())))
    ...
    void getComment() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.commentTime").value(DEFAULT_COMMENT_TIME.toString()))
    ...
    void putNewComment() throws Exception {
        ...
        assertThat(testComment.getCommentTime()).isEqualTo(UPDATED_COMMENT_TIME);
        assertThat(testComment.getCreatedBy()).isEqualTo(UPDATED_CREATED_BY);
        assertThat(testComment.getImageUrl()).isEqualTo(UPDATED_IMAGE_URL);
        assertThat(testComment.getReplay()).isEqualTo(UPDATED_REPLAY);
    }
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.text(UPDATED_TEXT).createdBy(UPDATED_CREATED_BY).imageUrl(UPDATED_IMAGE_URL).replay(UPDATED_REPLAY);
