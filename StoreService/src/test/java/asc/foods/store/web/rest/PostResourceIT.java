...
import asc.foods.store.repository.PostRepository;
import asc.foods.store.service.dto.PostDTO;
import asc.foods.store.service.mapper.PostMapper;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().decription(DEFAULT_DECRIPTION).postTime(DEFAULT_POST_TIME).createdBy(DEFAULT_CREATED_BY);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().decription(UPDATED_DECRIPTION).postTime(UPDATED_POST_TIME).createdBy(UPDATED_CREATED_BY);
        return post;
    }
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getPostTime()).isEqualTo(DEFAULT_POST_TIME);
    ...
    void putNewPost() throws Exception {
        ...
        updatedPost.decription(UPDATED_DECRIPTION).postTime(UPDATED_POST_TIME).createdBy(UPDATED_CREATED_BY);
        ...
        assertThat(testPost.getPostTime()).isEqualTo(UPDATED_POST_TIME);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.decription(UPDATED_DECRIPTION).postTime(UPDATED_POST_TIME).createdBy(UPDATED_CREATED_BY);
