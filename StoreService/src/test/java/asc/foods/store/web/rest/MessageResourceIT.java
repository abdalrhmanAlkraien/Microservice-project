...
import asc.foods.store.domain.enumeration.AscMediaType;
import asc.foods.store.domain.enumeration.Reaction;
import asc.foods.store.repository.MessageRepository;
import asc.foods.store.service.dto.MessageDTO;
import asc.foods.store.service.mapper.MessageMapper;
...
class MessageResourceIT {
    ...
    private static final Boolean DEFAULT_READ_BY = false;
    private static final Boolean UPDATED_READ_BY = true;

    private static final AscMediaType DEFAULT_MEDIA_TYPE = AscMediaType.TEXT;
    private static final AscMediaType UPDATED_MEDIA_TYPE = AscMediaType.FILE;

    private static final Reaction DEFAULT_REACTION = Reaction.NONE;
    private static final Reaction UPDATED_REACTION = Reaction.SMILE;
    ...
    void createMessage() throws Exception {
        ...
        assertThat(testMessage.getReadBy()).isEqualTo(DEFAULT_READ_BY);
        assertThat(testMessage.getMediaType()).isEqualTo(DEFAULT_MEDIA_TYPE);
        assertThat(testMessage.getReaction()).isEqualTo(DEFAULT_REACTION);
    }
    ...
    void getAllMessages() throws Exception {
        ...
        restMessageMockMvc
            ...
            .andExpect(jsonPath("$.[*].readBy").value(hasItem(DEFAULT_READ_BY.booleanValue())))
    ...
    void getMessage() throws Exception {
        ...
        restMessageMockMvc
            ...
            .andExpect(jsonPath("$.readBy").value(DEFAULT_READ_BY.booleanValue()))
    ...
    void putNewMessage() throws Exception {
        ...
        assertThat(testMessage.getReadBy()).isEqualTo(UPDATED_READ_BY);
        assertThat(testMessage.getMediaType()).isEqualTo(UPDATED_MEDIA_TYPE);
        assertThat(testMessage.getReaction()).isEqualTo(UPDATED_REACTION);
    }
    ...
    void partialUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.mediaType(UPDATED_MEDIA_TYPE).reaction(UPDATED_REACTION);
