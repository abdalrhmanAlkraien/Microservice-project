...
import asc.foods.store.repository.PostMultimediaRepository;
import asc.foods.store.service.PostMultimediaService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.PostMultimedia}.
 */
@RestController
@RequestMapping("/api")
public class PostMultimediaResource {
    ...
    private static final String ENTITY_NAME = "storeServicePostMultimedia";
