...
import asc.foods.store.repository.PromoCodeRepository;
import asc.foods.store.service.PromoCodeService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.PromoCode}.
 */
@RestController
@RequestMapping("/api")
public class PromoCodeResource {
    ...
    private static final String ENTITY_NAME = "storeServicePromoCode";
