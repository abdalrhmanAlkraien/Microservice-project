...
import asc.foods.store.repository.StoreFollowerRepository;
import asc.foods.store.service.StoreFollowerService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.StoreFollower}.
 */
@RestController
@RequestMapping("/api")
public class StoreFollowerResource {
    ...
    private static final String ENTITY_NAME = "storeServiceStoreFollower";
