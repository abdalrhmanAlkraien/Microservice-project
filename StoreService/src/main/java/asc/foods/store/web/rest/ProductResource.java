...
import asc.foods.store.repository.ProductRepository;
import asc.foods.store.service.ProductService;
import asc.foods.store.service.dto.ProductDTO;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "storeServiceProduct";
