...
import asc.foods.store.service.PostService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
    ...
    private static final String ENTITY_NAME = "storeServicePost";
