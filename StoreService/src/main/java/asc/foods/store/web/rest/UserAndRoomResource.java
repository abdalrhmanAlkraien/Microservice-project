...
import asc.foods.store.repository.UserAndRoomRepository;
import asc.foods.store.service.UserAndRoomService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.UserAndRoom}.
 */
@RestController
@RequestMapping("/api")
public class UserAndRoomResource {
    ...
    private static final String ENTITY_NAME = "storeServiceUserAndRoom";
