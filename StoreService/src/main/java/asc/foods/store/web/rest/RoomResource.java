...
import asc.foods.store.service.RoomService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.Room}.
 */
@RestController
@RequestMapping("/api")
public class RoomResource {
    ...
    private static final String ENTITY_NAME = "storeServiceRoom";
