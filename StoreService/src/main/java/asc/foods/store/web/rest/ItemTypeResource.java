...
import asc.foods.store.repository.ItemTypeRepository;
import asc.foods.store.service.ItemTypeService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.ItemType}.
 */
@RestController
@RequestMapping("/api")
public class ItemTypeResource {
    ...
    private static final String ENTITY_NAME = "storeServiceItemType";
