...
import asc.foods.store.repository.ReadByRepository;
import asc.foods.store.service.ReadByService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.ReadBy}.
 */
@RestController
@RequestMapping("/api")
public class ReadByResource {
    ...
    private static final String ENTITY_NAME = "storeServiceReadBy";
