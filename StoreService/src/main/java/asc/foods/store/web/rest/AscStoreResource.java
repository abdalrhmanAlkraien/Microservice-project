...
import asc.foods.store.repository.AscStoreRepository;
import asc.foods.store.service.AscStoreService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.AscStore}.
 */
@RestController
@RequestMapping("/api")
public class AscStoreResource {
    ...
    private static final String ENTITY_NAME = "storeServiceAscStore";
