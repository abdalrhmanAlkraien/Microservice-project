...
import asc.foods.store.service.OrderCustomeService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.OrderCustome}.
 */
@RestController
@RequestMapping("/api")
public class OrderCustomeResource {
    ...
    private static final String ENTITY_NAME = "storeServiceOrderCustome";
