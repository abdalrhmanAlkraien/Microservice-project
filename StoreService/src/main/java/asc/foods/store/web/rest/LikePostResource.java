...
import asc.foods.store.repository.LikePostRepository;
import asc.foods.store.service.LikePostService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.LikePost}.
 */
@RestController
@RequestMapping("/api")
public class LikePostResource {
    ...
    private static final String ENTITY_NAME = "storeServiceLikePost";
