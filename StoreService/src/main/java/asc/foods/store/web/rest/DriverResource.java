...
import asc.foods.store.repository.DriverRepository;
import asc.foods.store.service.DriverService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.Driver}.
 */
@RestController
@RequestMapping("/api")
public class DriverResource {
    ...
    private static final String ENTITY_NAME = "storeServiceDriver";
