...
import asc.foods.store.service.ProductTagService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.ProductTag}.
 */
@RestController
@RequestMapping("/api")
public class ProductTagResource {
    ...
    private static final String ENTITY_NAME = "storeServiceProductTag";
