...
import asc.foods.store.repository.LikeCommentRepository;
import asc.foods.store.service.LikeCommentService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.LikeComment}.
 */
@RestController
@RequestMapping("/api")
public class LikeCommentResource {
    ...
    private static final String ENTITY_NAME = "storeServiceLikeComment";
