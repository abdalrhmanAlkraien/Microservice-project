...
import asc.foods.store.service.MessageService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.Message}.
 */
@RestController
@RequestMapping("/api")
public class MessageResource {
    ...
    private static final String ENTITY_NAME = "storeServiceMessage";
