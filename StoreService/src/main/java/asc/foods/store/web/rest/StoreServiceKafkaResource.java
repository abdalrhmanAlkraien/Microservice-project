...
@RestController
@RequestMapping("/api/store-service-kafka")
public class StoreServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(StoreServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public StoreServiceKafkaResource(KafkaProperties kafkaProperties) {
