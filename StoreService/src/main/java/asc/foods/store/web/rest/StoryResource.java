...
import asc.foods.store.repository.StoryRepository;
import asc.foods.store.service.StoryService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.Story}.
 */
@RestController
@RequestMapping("/api")
public class StoryResource {
    ...
    private static final String ENTITY_NAME = "storeServiceStory";
