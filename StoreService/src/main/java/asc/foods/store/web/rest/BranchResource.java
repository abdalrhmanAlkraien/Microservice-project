...
import asc.foods.store.repository.BranchRepository;
import asc.foods.store.service.BranchService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.Branch}.
 */
@RestController
@RequestMapping("/api")
public class BranchResource {
    ...
    private static final String ENTITY_NAME = "storeServiceBranch";
