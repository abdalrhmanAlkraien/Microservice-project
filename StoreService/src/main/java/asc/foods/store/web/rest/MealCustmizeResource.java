...
import asc.foods.store.service.MealCustmizeService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.MealCustmize}.
 */
@RestController
@RequestMapping("/api")
public class MealCustmizeResource {
    ...
    private static final String ENTITY_NAME = "storeServiceMealCustmize";
