...
import asc.foods.store.repository.AscOrderRepository;
import asc.foods.store.service.AscOrderService;
import asc.foods.store.service.dto.AscOrderDTO;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.AscOrder}.
 */
@RestController
@RequestMapping("/api")
public class AscOrderResource {
    ...
    private static final String ENTITY_NAME = "storeServiceAscOrder";
