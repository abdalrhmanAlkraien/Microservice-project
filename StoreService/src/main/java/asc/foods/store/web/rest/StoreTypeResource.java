...
import asc.foods.store.service.StoreTypeService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.StoreType}.
 */
@RestController
@RequestMapping("/api")
public class StoreTypeResource {
    ...
    private static final String ENTITY_NAME = "storeServiceStoreType";
