...
import asc.foods.store.service.SaveService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.Save}.
 */
@RestController
@RequestMapping("/api")
public class SaveResource {
    ...
    private static final String ENTITY_NAME = "storeServiceSave";
