...
import asc.foods.store.service.UserProductService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.UserProduct}.
 */
@RestController
@RequestMapping("/api")
public class UserProductResource {
    ...
    private static final String ENTITY_NAME = "storeServiceUserProduct";
