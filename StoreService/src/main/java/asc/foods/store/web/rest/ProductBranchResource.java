...
import asc.foods.store.service.ProductBranchService;
...
/**
 * REST controller for managing {@link asc.foods.store.domain.ProductBranch}.
 */
@RestController
@RequestMapping("/api")
public class ProductBranchResource {
    ...
    private static final String ENTITY_NAME = "storeServiceProductBranch";
