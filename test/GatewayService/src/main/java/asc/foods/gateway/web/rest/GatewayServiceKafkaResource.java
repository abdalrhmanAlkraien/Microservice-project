...
@RestController
@RequestMapping("/api/gateway-service-kafka")
public class GatewayServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GatewayServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GatewayServiceKafkaResource(KafkaProperties kafkaProperties) {
