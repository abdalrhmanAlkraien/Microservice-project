package asc.foods.gateway.repository;
...
import asc.foods.gateway.config.audit.AuditEventConverter;
import asc.foods.gateway.domain.PersistentAuditEvent;
...
import static asc.foods.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
