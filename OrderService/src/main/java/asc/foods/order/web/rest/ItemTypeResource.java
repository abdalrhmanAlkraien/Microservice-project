...
import asc.foods.order.service.ItemTypeService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.ItemType}.
 */
@RestController
@RequestMapping("/api")
public class ItemTypeResource {
    ...
    private static final String ENTITY_NAME = "orderServiceItemType";
