...
import asc.foods.order.repository.CommentRepository;
import asc.foods.order.service.CommentService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
public class CommentResource {
    ...
    private static final String ENTITY_NAME = "orderServiceComment";
