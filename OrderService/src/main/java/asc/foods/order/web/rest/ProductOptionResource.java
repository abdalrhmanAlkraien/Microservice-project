...
import asc.foods.order.repository.ProductOptionRepository;
import asc.foods.order.service.ProductOptionService;
import asc.foods.order.service.dto.ProductOptionDTO;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.ProductOption}.
 */
@RestController
@RequestMapping("/api")
public class ProductOptionResource {
    ...
    private static final String ENTITY_NAME = "orderServiceProductOption";
