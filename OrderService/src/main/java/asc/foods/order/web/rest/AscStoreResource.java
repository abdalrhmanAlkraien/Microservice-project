...
import asc.foods.order.service.AscStoreService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.AscStore}.
 */
@RestController
@RequestMapping("/api")
public class AscStoreResource {
    ...
    private static final String ENTITY_NAME = "orderServiceAscStore";
