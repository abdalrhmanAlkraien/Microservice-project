...
import asc.foods.order.service.ProductService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "orderServiceProduct";
