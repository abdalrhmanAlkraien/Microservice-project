...
@RestController
@RequestMapping("/api/order-service-kafka")
public class OrderServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(OrderServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public OrderServiceKafkaResource(KafkaProperties kafkaProperties) {
