...
import asc.foods.order.service.OrderCustomeService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.OrderCustome}.
 */
@RestController
@RequestMapping("/api")
public class OrderCustomeResource {
    ...
    private static final String ENTITY_NAME = "orderServiceOrderCustome";
