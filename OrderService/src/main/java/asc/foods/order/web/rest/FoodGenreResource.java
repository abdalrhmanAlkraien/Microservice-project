...
import asc.foods.order.repository.FoodGenreRepository;
import asc.foods.order.service.FoodGenreService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.FoodGenre}.
 */
@RestController
@RequestMapping("/api")
public class FoodGenreResource {
    ...
    private static final String ENTITY_NAME = "orderServiceFoodGenre";
