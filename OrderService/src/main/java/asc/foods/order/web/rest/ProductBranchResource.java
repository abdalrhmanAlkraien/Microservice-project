...
import asc.foods.order.repository.ProductBranchRepository;
import asc.foods.order.service.ProductBranchService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.ProductBranch}.
 */
@RestController
@RequestMapping("/api")
public class ProductBranchResource {
    ...
    private static final String ENTITY_NAME = "orderServiceProductBranch";
