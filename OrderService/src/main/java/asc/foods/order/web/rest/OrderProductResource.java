...
import asc.foods.order.service.OrderProductService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.OrderProduct}.
 */
@RestController
@RequestMapping("/api")
public class OrderProductResource {
    ...
    private static final String ENTITY_NAME = "orderServiceOrderProduct";
