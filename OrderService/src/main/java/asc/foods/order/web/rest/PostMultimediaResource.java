...
import asc.foods.order.repository.PostMultimediaRepository;
import asc.foods.order.service.PostMultimediaService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.PostMultimedia}.
 */
@RestController
@RequestMapping("/api")
public class PostMultimediaResource {
    ...
    private static final String ENTITY_NAME = "orderServicePostMultimedia";
