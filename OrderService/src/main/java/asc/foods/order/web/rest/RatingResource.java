...
import asc.foods.order.service.RatingService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.Rating}.
 */
@RestController
@RequestMapping("/api")
public class RatingResource {
    ...
    private static final String ENTITY_NAME = "orderServiceRating";
