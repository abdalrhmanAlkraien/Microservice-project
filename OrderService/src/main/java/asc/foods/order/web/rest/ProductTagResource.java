...
import asc.foods.order.service.ProductTagService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.ProductTag}.
 */
@RestController
@RequestMapping("/api")
public class ProductTagResource {
    ...
    private static final String ENTITY_NAME = "orderServiceProductTag";
