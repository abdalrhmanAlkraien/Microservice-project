...
import asc.foods.order.service.PostService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
    ...
    private static final String ENTITY_NAME = "orderServicePost";
