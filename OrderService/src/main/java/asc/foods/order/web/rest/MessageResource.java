...
import asc.foods.order.service.MessageService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.Message}.
 */
@RestController
@RequestMapping("/api")
public class MessageResource {
    ...
    private static final String ENTITY_NAME = "orderServiceMessage";
