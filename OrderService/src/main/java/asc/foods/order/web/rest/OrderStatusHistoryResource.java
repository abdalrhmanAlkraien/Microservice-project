...
import asc.foods.order.repository.OrderStatusHistoryRepository;
import asc.foods.order.service.OrderStatusHistoryService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.OrderStatusHistory}.
 */
@RestController
@RequestMapping("/api")
public class OrderStatusHistoryResource {
    ...
    private static final String ENTITY_NAME = "orderServiceOrderStatusHistory";
