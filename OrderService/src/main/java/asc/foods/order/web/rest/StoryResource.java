...
import asc.foods.order.service.StoryService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.Story}.
 */
@RestController
@RequestMapping("/api")
public class StoryResource {
    ...
    private static final String ENTITY_NAME = "orderServiceStory";
