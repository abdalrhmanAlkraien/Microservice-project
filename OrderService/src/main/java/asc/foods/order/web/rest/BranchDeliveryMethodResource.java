...
import asc.foods.order.service.BranchDeliveryMethodService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.BranchDeliveryMethod}.
 */
@RestController
@RequestMapping("/api")
public class BranchDeliveryMethodResource {
    ...
    private static final String ENTITY_NAME = "orderServiceBranchDeliveryMethod";
