...
import asc.foods.order.service.UserAndRoomService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.UserAndRoom}.
 */
@RestController
@RequestMapping("/api")
public class UserAndRoomResource {
    ...
    private static final String ENTITY_NAME = "orderServiceUserAndRoom";
