...
import asc.foods.order.repository.UserAddressRepository;
import asc.foods.order.service.UserAddressService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.UserAddress}.
 */
@RestController
@RequestMapping("/api")
public class UserAddressResource {
    ...
    private static final String ENTITY_NAME = "orderServiceUserAddress";
