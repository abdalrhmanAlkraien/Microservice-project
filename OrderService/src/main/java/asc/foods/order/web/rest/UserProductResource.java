...
import asc.foods.order.repository.UserProductRepository;
import asc.foods.order.service.UserProductService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.UserProduct}.
 */
@RestController
@RequestMapping("/api")
public class UserProductResource {
    ...
    private static final String ENTITY_NAME = "orderServiceUserProduct";
