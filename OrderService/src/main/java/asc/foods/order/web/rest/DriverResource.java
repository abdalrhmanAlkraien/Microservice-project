...
import asc.foods.order.service.DriverService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.Driver}.
 */
@RestController
@RequestMapping("/api")
public class DriverResource {
    ...
    private static final String ENTITY_NAME = "orderServiceDriver";
