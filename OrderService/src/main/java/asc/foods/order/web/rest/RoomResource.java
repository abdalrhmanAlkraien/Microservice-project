...
import asc.foods.order.service.RoomService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.Room}.
 */
@RestController
@RequestMapping("/api")
public class RoomResource {
    ...
    private static final String ENTITY_NAME = "orderServiceRoom";
