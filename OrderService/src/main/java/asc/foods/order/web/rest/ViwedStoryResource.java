...
import asc.foods.order.repository.ViwedStoryRepository;
import asc.foods.order.service.ViwedStoryService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.ViwedStory}.
 */
@RestController
@RequestMapping("/api")
public class ViwedStoryResource {
    ...
    private static final String ENTITY_NAME = "orderServiceViwedStory";
