...
import asc.foods.order.repository.BranchRepository;
import asc.foods.order.service.BranchService;
...
/**
 * REST controller for managing {@link asc.foods.order.domain.Branch}.
 */
@RestController
@RequestMapping("/api")
public class BranchResource {
    ...
    private static final String ENTITY_NAME = "orderServiceBranch";
