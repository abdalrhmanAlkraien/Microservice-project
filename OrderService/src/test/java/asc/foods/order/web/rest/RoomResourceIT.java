...
import asc.foods.order.repository.RoomRepository;
import asc.foods.order.service.dto.RoomDTO;
import asc.foods.order.service.mapper.RoomMapper;
...
class RoomResourceIT {
    ...
    private static final Long DEFAULT_USER_SENDER = 1L;
    private static final Long UPDATED_USER_SENDER = 2L;

    private static final Long DEFAULT_USER_RECIVER = 1L;
    private static final Long UPDATED_USER_RECIVER = 2L;
    ...
    public static Room createEntity(EntityManager em) {
        Room room = new Room().userSender(DEFAULT_USER_SENDER).userReciver(DEFAULT_USER_RECIVER);
        return room;
    }
    ...
    public static Room createUpdatedEntity(EntityManager em) {
        Room room = new Room().userSender(UPDATED_USER_SENDER).userReciver(UPDATED_USER_RECIVER);
        return room;
    }
    ...
    void createRoom() throws Exception {
        ...
        assertThat(testRoom.getUserSender()).isEqualTo(DEFAULT_USER_SENDER);
        assertThat(testRoom.getUserReciver()).isEqualTo(DEFAULT_USER_RECIVER);
    }
    ...
    void getAllRooms() throws Exception {
        ...
        restRoomMockMvc
            ...
            .andExpect(jsonPath("$.[*].userSender").value(hasItem(DEFAULT_USER_SENDER.intValue())))
            .andExpect(jsonPath("$.[*].userReciver").value(hasItem(DEFAULT_USER_RECIVER.intValue())));
    }
    ...
    void getRoom() throws Exception {
        ...
        restRoomMockMvc
            ...
            .andExpect(jsonPath("$.userSender").value(DEFAULT_USER_SENDER.intValue()))
            .andExpect(jsonPath("$.userReciver").value(DEFAULT_USER_RECIVER.intValue()));
    }
    ...
    void putNewRoom() throws Exception {
        ...
        updatedRoom.userSender(UPDATED_USER_SENDER).userReciver(UPDATED_USER_RECIVER);
        ...
        Room testRoom = roomList.get(roomList.size() - 1);
        assertThat(testRoom.getUserSender()).isEqualTo(UPDATED_USER_SENDER);
        assertThat(testRoom.getUserReciver()).isEqualTo(UPDATED_USER_RECIVER);
    }
    ...
    void partialUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.userReciver(UPDATED_USER_RECIVER);
    ...
    void fullUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.userSender(UPDATED_USER_SENDER).userReciver(UPDATED_USER_RECIVER);
